...
3. 严格客观，好消息坏消息都说，不讨好读者，该泼冷水就泼
4. 不用任何技术术语。非大众熟知的公司/产品/概念必须加括号注释说明它是干嘛的
...
5. 如果一条”行业洞察”只是把前文 section 标题换个说法重新表达，没有新增判断，就算不合格`
...
🗺️ 今日关系图
在行业洞察末尾，输出一段 mermaid 图（三个反引号mermaid围栏）。设计原则: 让读者 3 秒看懂今天最重要的 3 件事怎么关联。要求:
